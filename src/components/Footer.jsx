...
const Footer = ({ theme }) => {
  return (
    <div className="bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-20 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40">
      ...
      <div className="pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap">
        <p>
          Copyright {new Date().getFullYear()} &copy; Agency - All Rights
          Reserved
        </p>
