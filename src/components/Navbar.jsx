...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <motion.div
      ...
      className="flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/40 dark:bg-teal-950/30 border border-white/20 dark:border-teal-500/10"
    >
      <img src={assets.logo} className="w-32 sm:w-40" alt="agency" />
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        >
          Connect <img src={assets.arrow_icon} width={14} alt="arrow right" />
        </a>
      </div>
    </motion.div>
  );
